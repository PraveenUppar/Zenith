...
<!-- Place your screen recording GIF or link here -->
...
SSH into it: ssh ubuntu@<your-server-ip>
...
2. **Secrets:** Create a `.env` file on the server with your real AWS keys and Redis URL.

3. **Run:**
   docker-compose up -d

   _(The `-d` runs it in the background)_
